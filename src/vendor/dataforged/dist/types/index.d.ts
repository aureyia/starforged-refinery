 ...
 * @public
 */
export declare interface IAlterMove
  extends StubBy<
    IMove,
    'Trigger' | 'Text',
 ...
 * @public
 */
export declare interface IAlterMoveOutcomes
  extends Omit<IMoveOutcomes, keyof typeof MoveOutcome> {
 ...
 * @public
 */
export declare interface IAlterOutcomeInfo
  extends Omit<PartialDeep<IOutcomeInfo>, 'With a Match'> {
 ...
 * @public
 */
export declare interface IAssetType
  extends IHasName,
    IHasId,
    IHasDescription,
    IHasDisplay,
 ...
 * @public
 */
export declare interface ICyclopediaEntry
  extends IHasName,
    IHasId,
    IHasDisplay,
    IHasDescription,
    IHasSource,
    Partial<IHasSummary & IHasQuestStarter & IHasTags> {
  /**
 ...
 * @public
 */
export declare interface IDelveCard
  extends IHasName,
    IHasSource,
    IHasSummary,
    IHasDescription,
 ...
 * @public
 */
export declare interface IEncounterNatureInfo
  extends IHasDescription,
    IHasSource,
    IHasName,
    IHasId,
    IHasDisplay,
 ...
 * @public
 */
export declare interface IEncounterVariant
  extends StubBy<
 ...
 * @public
 */
export declare interface IInputSelectOptionSetterMeter
  extends IInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface IInputSelectOptionSetterNumber
  extends IInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface IInputSelectOptionSetterStat
  extends IInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface IInputSelectOptionSetterString
  extends IInputSelectOptionSetter {
 ...
 * @public
 */
export declare interface IMoveCategory
  extends IHasId,
    IHasName,
    IHasSource,
    IHasDescription,
...
export declare interface IMoveTriggerOptionAction
  extends IMoveTriggerOptionBase {
 ...
 * @public
 */
export declare interface IMoveTriggerOptionBase
  extends IHasId,
    Partial<IHasText> {
  /**
 ...
 * @public
 */
export declare interface IMoveTriggerOptionProgress
  extends IMoveTriggerOptionBase {
 ...
 * @public
 */
export declare interface IOracleBase
  extends Partial<IHasAliases & IHasDescription & IHasOracleContent>,
    IHasId,
    IHasDisplay,
    IHasSource,
    IHasName {
 ...
 * @public
 */
export declare interface IOracleUsage
  extends Partial<IHasRequirements & IHasSuggestions & IHasRollTemplate> {
  /**
 ...
 * @public
 */
export declare interface ISettingTruth
  extends IHasId,
    IHasName,
    IHasSource,
    IHasDisplay,
 ...
 * @public
 */
export declare interface ISettingTruthOption
  extends IRow,
    IHasQuestStarter,
    IHasDescription {
  /**
 ...
 * @public
 */
export declare type PartialBy<T, K extends keyof any = ''> = Omit<T, K> &
 ...
 * @public
 */
export declare type PartialDeepBy<T, K extends keyof any = ''> = Omit<T, K> &
  PartialDeep<Pick<T, K extends keyof T ? K : never>>
 ...
 * @public
 */
export declare type RollableStat =
  | Stat
  | ICustomStat['$id']
 ...
 * @public
 */
export declare type StubExcept<
  T,
 ...
 * @public
 */
export declare type Tuple<TItem, TLength extends number> = [
  TItem,
  ...TItem[],
] & {
  length: TLength
